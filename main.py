                    ...
                    for B in B_vals:
                        for A in A_vals:
                            for alpha in alpha_vals:
                                for p_vec in p_vec_list:
                                    input_data, filename = gen_wp_input_2(alpha, A,B,W,p_vec[0],p_vec[1],xran,yran,pxmax,pymax)
                                    write_input(filename,input_data)
                                    with open(filename) as f:
                                        for line in f:
                                            line1 = line.replace(" ", "")
                ...
                for W in W_vals:
                    for B in B_vals:
                        for A in A_vals:
                            for alpha in alpha_vals:
                                for p_vec in p_vec_list:
                                    input_data, filename = gen_sh_input_2(alpha,A, B, W, N, p_vec[0], p_vec[1], rescale_method)
                                    write_input(filename, input_data)
                                    with open(filename) as f:
                                        for line in f:
                                            line1 = line.replace(" ", "")

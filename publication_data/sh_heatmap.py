...
# this program computes the wavepacket density on a heatmap from the output of the FSSH simulation #
...
# normalize populations to number of trajectories
...
# for each timestep save the heatmap
